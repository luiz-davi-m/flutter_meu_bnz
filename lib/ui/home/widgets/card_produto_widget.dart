    ...
    return Card(
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8), // Margem ajustada
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start, // Alinhamento à esquerda para o texto
              children: [
                ElevatedButton(
                  onPressed: () {},
                  style: ElevatedButton.styleFrom(
                    ...
                    padding: EdgeInsets.symmetric(vertical: 4, horizontal: 8), // Diminuído o padding
                  ),
                  child: Text(
                    "Expira em 10 dias",
